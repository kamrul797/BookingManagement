  ...
  <form role="form" action="<?php echo WEB_ROOT; ?>views/process.php?cmd=create" method="post">
    <div class="box-body">
	  ...
	  <div class="form-group">
        ...
        <textarea name="address" class="form-control input-sm" placeholder="Course Code"></textarea>
	  ...
	  <div class="form-group">
        ...
        <input type="number" name="phone" class="form-control input-sm"  placeholder="Phone number">
		<span class="textfieldRequiredMsg">Phone number is required.(Only number [0-9] is allowed)</span>
    <span class="textareaMinCharsMsg">Phone Number must specify at least 11 characters.</span>	
		</span>
      </div>
	  <div class="form-group">
...
var sprytf_address 	= new Spry.Widget.ValidationTextarea("sprytf_address", {minChars:7, isRequired:true, validateOn:["blur", "change"]});
var sprytf_phone 	= new Spry.Widget.ValidationTextField("sprytf_phone", 'none', {minChars:11, validateOn:["blur", "change"]});
