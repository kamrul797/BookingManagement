...
<div class="box box-primary">
  <div class="box-header with-border">
    <h3 class="box-title"><b>Book Venue</b></h3>
  </div>
  <!-- /.box-header -->
  <!-- form start -->
  <form role="form" action="<?php echo WEB_ROOT; ?>api/process.php?cmd=book" method="post">
    <div class="box-body">
	  ...
	  <div class="form-group">
        ...
        <textarea name="address" class="form-control input-sm" placeholder="Course Code" id="address"></textarea>
		<span class="textareaRequiredMsg">Course Code is required.</span>
				</span>
      </div>
	  <div class="form-group">
        <label>Phone</label>
	  ...
	  <div class="form-group">
		...
		<span class="textfieldInvalidFormatMsg">Please enter a valid email (ex. user@domain.com).</span>
		</span>
      </div>
	  ...
	  <div class="form-group">
        ...
        <input type="text" name="ucount" class="form-control input-sm" placeholder="301,302,303" >
		<span class="textfieldRequiredMsg">Room Number is required.</span>
	  ...
	  <div class="form-group">
        ...
        <textarea name="comment" class="form-control input-sm" placeholder="Booking purpose" id="comment"></textarea>
		<span class="textareaRequiredMsg">Booking Purpose is required.</span>
				</span>
      </div>
...
var sprytf_comment 	= new Spry.Widget.ValidationTextarea("sprytf_comment", {minChars:3, isRequired:true, validateOn:["blur", "change"]});
//-->
</script>
